...
fn main() {
    ...
    let birth_date_str = json["vc"]["credentialSubject"]["birth_date"].as_str().ok_or("Missing birthdate");
    ...
    let birth_date = NaiveDate::parse_from_str(birth_date_str.unwrap_or("unknown"), "%Y-%m-%d").expect("Invalid date string.");
